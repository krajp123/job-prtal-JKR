    ...
    return (
        <div>
            <button
                ...
                className={`flex w-full items-center gap-3 rounded-2xl border px-3 py-2.5 text-left transition-all duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#C75560] ${expanded ? 'border-[#1D181A] text-white shadow-[0_16px_30px_-20px_rgba(29,24,26,0.62)]' : 'border-[#EBC2AE] bg-[#FFFDFC] text-[#1D181A] shadow-[0_12px_26px_-22px_rgba(29,24,26,0.32)] hover:border-[#C75560] hover:bg-[#FFF0E8]'} ${compactRail ? 'flex-col justify-center gap-2 px-2 py-3' : ''}`}
            ...
            <AnimatePresence initial={false}>
                {expanded && <motion.div initial={{ opacity: 0, height: 0, y: -6 }} animate={{ opacity: 1, height: 'auto', y: 0 }} exit={{ opacity: 0, height: 0, y: -6 }} transition={{ duration: 0.2 }} className="overflow-hidden">
                    <div className="mt-3 rounded-2xl border border-[#EBC2AE] bg-[#FFFDFC] p-5 shadow-[0_16px_36px_-28px_rgba(29,24,26,0.28)]">
